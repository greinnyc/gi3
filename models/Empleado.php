...
class Empleado extends \yii\db\ActiveRecord
{
    ...
    public function getEmpleadoDocumentoIndentidad(){
        $query = Yii::$app->db_invitado->createCommand("SELECT DISTINCT e.empleado_codigo,nombre,apellido_materno,apellido_paterno,estado_codigo,i.activo,i.evento_codigo,
            e.numero_documento
